...
expected( 'with dna', readgedcom.find_individuals( data, 'even.dna', '', 'exist' ), '5 and 16' )

expected( 'has dna 42', readgedcom.find_individuals( data, 'even.dna', '42', '=' ), '16' )

expected( 'has dna 60', readgedcom.find_individuals( data, 'even.dna', '60', '=' ), '5 and 16' )

expected( 'every male', readgedcom.find_individuals( data, 'sex', 'M', '=' ), '2 and 3' )

expected( 'every female', readgedcom.find_individuals( data, 'sex', 'F', '=' ), '4 and 14' )

expected( 'every make; only-best=false', readgedcom.find_individuals( data, 'sex', 'M', '=', False ), '2, 3 and 14' )

expected( 'every femake; only-best=false', readgedcom.find_individuals( data, 'sex', 'F', '=', False ), '2, 4 and 14' )
...
expected( 'name contains alt', readgedcom.find_individuals( data, 'name', 'Alt', 'in', True ), 'none' )

expected( 'name contains alt; only-best=false', readgedcom.find_individuals( data, 'name', 'Alt', 'in', False ), '1 and 15' )

expected( 'has birth', readgedcom.find_individuals( data, 'birth', '', 'exist'), '5,6,7,8,9,10,11' )

expected( 'has death', readgedcom.find_individuals( data, 'death', '', 'exist'), 'none' )
expected( 'has death date', readgedcom.find_individuals( data, 'deat.date', '', 'exist'), 'none' )
expected( 'has death place', readgedcom.find_individuals( data, 'death.place', '', 'exist'), 'none' )

expected( 'has birth date', readgedcom.find_individuals( data, 'birt.date', '', 'exist'), '5,6,7 and 11' )
...
expected( 'born after 1949; only-best=false', readgedcom.find_individuals( data, 'birth.date', '19491231', '>', False), '7 and 11' )

expected( 'born in Toronto', readgedcom.find_individuals( data, 'birt.place', 'To', 'in'), '8 and 10' )

expected( 'born in Montreal', readgedcom.find_individuals( data, 'birt.place', 'Montreal', '=', True), '9' )

expected( 'born in Montreal; only-best=false', readgedcom.find_individuals( data, 'birt.place', 'Montreal', '=', False), '9 and 10' )
